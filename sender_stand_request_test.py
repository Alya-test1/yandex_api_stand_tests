import sender_stand_request_test
import data
...
def positive_assert(first_name):
    ...
    user_response = sender_stand_request_test.post_new_user(user_body)
    ...
    users_table_response = sender_stand_request_test.get_users_table()
...
def negative_assert_symbol(first_name):
    ...
    response = sender_stand_request_test.post_new_user(user_body)
